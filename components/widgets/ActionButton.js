...
const ActionButton = ({ children, arrow = false, comment = false }) => {
    return (
        <button className="group cursor-pointer relative flex items-center justify-center gap-x-3 text-white border-[2px] border-[#9c86ff] bg-gradient-to-t from-[#896EFD] to-[#6B4AFC] text-[16px] lg:text-lg font-medium leading-[17px] px-[12px] py-[8px] lg:px-12 lg:py-4 rounded-[10px] font-konnect ">
